  ...
  return (
    <>
      ...
      <article className="recipe__container">
        <img src={obj.img} alt="recipe img" />
        <div className="recipe__text-container">
          <div className="recipe__text-one">
            <div className="recipe__meal-type">{obj.mealType}</div>
            <h4 className="recipe__tittle">{obj.title}</h4>
          </div>
        </div>
        <div className="recipe__footer">
          <span className="recipe__cuisine-type">{obj.cuisineType}</span>
          <img
